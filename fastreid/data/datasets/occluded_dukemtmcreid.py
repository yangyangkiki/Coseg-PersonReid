...
class OccludedDukeMTMCreID(ImageDataset):
    """DukeMTMC-reID-occ.
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        # # cluster:
        # self.dataset_dir = osp.join(self.root, 'dukemtmc-reid')
        ...
        super(OccludedDukeMTMCreID, self).__init__(train, query, gallery, **kwargs)
