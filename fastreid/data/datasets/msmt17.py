...
class MSMT17(ImageDataset):
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        has_main_dir = False
        for main_dir in VERSION_DICT:
            if osp.exists(osp.join(self.dataset_dir, 'msmt17', main_dir)):
                train_dir = VERSION_DICT[main_dir][TRAIN_DIR_KEY]
                test_dir = VERSION_DICT[main_dir][TEST_DIR_KEY]
                has_main_dir = True
                break
        ...
        self.train_dir = osp.join(self.dataset_dir,'msmt17', main_dir, train_dir)
        self.test_dir = osp.join(self.dataset_dir, 'msmt17',main_dir, test_dir)
        self.list_train_path = osp.join(self.dataset_dir, 'msmt17',main_dir, 'list_train.txt')
        self.list_val_path = osp.join(self.dataset_dir, 'msmt17',main_dir, 'list_val.txt')
        self.list_query_path = osp.join(self.dataset_dir, 'msmt17',main_dir, 'list_query.txt')
        self.list_gallery_path = osp.join(self.dataset_dir, 'msmt17',main_dir, 'list_gallery.txt')
