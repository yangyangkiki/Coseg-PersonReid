...
def build_reid_train_loader(cfg):
    ...
    for d in cfg.DATASETS.NAMES:
        ...
        dataset = DATASET_REGISTRY.get(d)(root=cfg.DATASETS.ROOT_DIR, combineall=cfg.DATASETS.COMBINEALL,cuhk03_labeled=cfg.DATASETS.CUHKLABELED)  # zhaoyang
...
def build_reid_test_loader(cfg, dataset_name):
    ...
    dataset = DATASET_REGISTRY.get(dataset_name)(root=cfg.DATASETS.ROOT_DIR,cuhk03_labeled=cfg.DATASETS.CUHKLABELED)
    if comm.is_main_process():
        dataset.show_test()
