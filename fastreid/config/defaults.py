...
# NonLap Loss options
_C.MODEL.LOSSES.SL = CN()
_C.MODEL.LOSSES.SL.RADIUS = 2
_C.MODEL.LOSSES.SL.STD = 0.2
_C.MODEL.LOSSES.SL.ALPHA = 1
_C.MODEL.LOSSES.SL.BETA = 0.001
_C.MODEL.LOSSES.SL.SCALE = 0.5

# CONCENTRATIONLOSS
_C.MODEL.LOSSES.CL = CN()
_C.MODEL.LOSSES.CL.SCALE = 0.0
...
# CUHK label or detect

_C.DATASETS.CUHKLABELED = False
# -----------------------------------------------------------------------------
# DataLoader
# -----------------------------------------------------------------------------
_C.DATALOADER = CN()
...
# interpratable
_C.INTERPRATABLE = CN()
_C.INTERPRATABLE.NPARTS = 5
_C.INTERPRATABLE.VISUALIZATION = False
_C.INTERPRATABLE.VISUALIZE_NUM = 50
_C.INTERPRATABLE.ONLY_INTER_HEAD = False
_C.INTERPRATABLE.PART_DIM = 256
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "logs/"
